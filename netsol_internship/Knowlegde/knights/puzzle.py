...
AStatementIsKnave = Symbol("A said 'I am a Knave'")
...
knowledge3 = And(
    ...
    # A is either a knight or a knave (exclusive)
    Or(AKnight, AKnave),
    Not(And(AKnight, AKnave)),
    ...
    # If A said "I am a knave", it creates a paradox and must be false
    Not(AStatementIsKnave),
